 ...
 * @created 2022/1/29
 */
public class Cohesion1 extends AbstractObjectiveFunction {
    /**
     * key为系统内文件id
     * value为key的所有传入文件id
     */
    ...
    public Cohesion1(double originCohesion) {
        this.objectiveFunctionTitle = "所有组件内聚";
        this.originCohesion = originCohesion;
    }

    public Cohesion1(FitnessCalculator fitnessCalculator) {
...
//        return 1 + ((currentCohesion - originCohesion) / originCohesion);
