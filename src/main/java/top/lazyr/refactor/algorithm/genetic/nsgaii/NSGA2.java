...
//        reporter.reportGeneration(parent, 0);
        int generation = 0;

        while(configuration.getTerminatingCriterion().shouldRun(child, ++generation, this.configuration.getMaxGenerations())) {
...
//            ConsoleConstant.printTitle(generation + "");
//            reporter.reportGeneration(child, generation);
        }
