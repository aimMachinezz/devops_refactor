 ...
 * @created 2022/1/28
 */
public class RefactorListGenerator12 extends RefactorListGenerator {
    private static Logger logger = LoggerFactory.getLogger(RefactorListGenerator12.class);
    private Graph graph;
    ...
    public RefactorListGenerator12(Graph graph, List<Node> smellComponentNodes) {
        this.graph = graph;
    ...
    public String getIntroduction() {
        return "static moveFiles(生成完全不一样的重构次操作)";
    }
