 ...
 * @created 2022/2/5
 */
public class RefactorListGenerator21 extends RefactorListGenerator {
    private static Logger logger = LoggerFactory.getLogger(RefactorListGenerator21.class);
    private Graph graph;
    ...
    public RefactorListGenerator21(Graph graph, List<Node> smellComponentNodes) {
        this.graph = graph;
    ...
    public String getIntroduction() {
        return "static moveFiles(生成完全不冲突的重构次操作) && extractComponent";
    }
